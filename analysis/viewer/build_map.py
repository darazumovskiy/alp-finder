...
POINTS = [
    ...
    dict(kind="rope", src="shtab", status="open", conf=4, lat=39.4814, lon=73.5928, alt=5118,
         ...
         coord="триангуляция трёх ракурсов: панорама 14.08 (SUPR 0010) и два зависания утра "
               ...
               "в расчёт не входит. Независимая проверка: луч через пиксель верёвки в кадре "
               "11.08 (после починки телеметрии ролика) даёт 39.481055–39.481268, "
               "73.592627–73.592700, 5092–5104 м — в 17–41 м отсюда, то есть сходится "
               "в пределах вилок. Прежняя оценка CC 39.481591, 73.592787, 5073 м ±48 м",
    ...
    dict(kind="object", src="tg", status="rejected", conf="x", lat=39.481279, lon=73.592673, alt=5099,
         ...
         coord="триангуляция 3 лучей (зум-тайл + W-кадры панорам 0004/0005, базис ~100 м), "
               ...
               "цепочка ~20 м (5091, 5099 и 5107 м) между перилами 5119 и верёвкой седловины",

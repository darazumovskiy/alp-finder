...
POINTS = [
    ...
    dict(kind="bird", src="ai", status="open", conf=3, lat=39.486171, lon=73.594699, alt=4925,
         ...
         who="личный отсмотр оператора проекта 16.08; движение подтверждено разностью "
             "стабилизированных кадров",
         desc="Живая крупная тёмная птица (ворон или клушица), перемещается по кромке той же "
              "гряды, где лежит оранжевая ткань (44 м к СВ от неё). Падальщики — косвенный "
              "индикатор для поиска: участок гряды заслуживает досмотра с малой высоты.",
         imgs=["analysis/fullframe/voron-183932/voron-t306_full.jpg",
               "analysis/fullframe/voron-183932/voron-t306_crop.jpg",
               "analysis/fullframe/voron-183932/voron-t307_crop.jpg"]),
